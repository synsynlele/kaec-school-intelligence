...
-- Remove broad table-level UPDATE privilege, then restore only the fields that
-- ordinary authenticated users are allowed to edit directly.
...
-- Final diagnoses cannot be returned to draft through ordinary editing because
-- status/reviewer/finaliser columns are no longer directly updateable.
