-- KAEC School Intelligence — Stage 4 concise diagnosis review freshness
-- The parent-facing concise diagnosis is material reviewed content. Any change
-- after review must invalidate that review; final content remains immutable.
