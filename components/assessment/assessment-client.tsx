          ...
          <section className="mt-8 rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-8">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button type="button" onClick={() => void downloadPdf("docx")} disabled={downloading || selectedAssessment.status !== "validated"} className="min-h-11 rounded-xl border border-zinc-300 px-4 py-2.5 text-sm font-semibold text-zinc-800 disabled:opacity-50">Download Exam Word</button>
              </div>
            </div>
